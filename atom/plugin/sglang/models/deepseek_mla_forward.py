...
try:
    from sglang.srt.model_executor.cuda_graph_runner import get_is_capture_mode  # sglang<=0.5.13 tag
except (ImportError, ModuleNotFoundError):
    from sglang.srt.model_executor.runner_utils.capture_mode import get_is_capture_mode  # newer sglang build
