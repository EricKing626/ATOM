...
class MooncakeConnector(KVConnectorBase):
        ...
        **Consumer side**: For each pending recv request, connect to the
        ...
        for req_id, meta in metadata.reqs_to_recv.items():
            ...
            with self._completion_lock:
                self._pending_recv_expected[req_id] = remote_pp_size
    ...
    def _execute_block_slot_transfer(
        ...
        block_cmap = self._consumer_region_map(len(self._v4_block_regions))
        ...
        slot_cmap = self._consumer_region_map(len(self._v4_slot_regions))
